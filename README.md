...
- 🏗️ 클라우드 플랫폼 **`Pickle`** 을 기획부터 개발과 운영까지 맡았고, SW프로젝트관리시스템 **`Opus`** 에서는 기획과 인프라를 담당했습니다. 둘 다 지금까지 교내에서 서비스 중입니다.
...
SSH 게이트웨이, 웹 터미널, 도메인 HTTPS 공개, 포트 포워딩 등 접근·네트워크 기능을 구현했습니다.
...
| 2025.03 ~ | PNUops | Pickle 기획·개발·운영 총괄 · Opus 기획 및 인프라 |
| 2025.01 ~ 2025.02 | LG CNS 스마트팩토리 사업부 | 인턴 · RMS 개발 · 엔터프라이즈 환경 운영 프로세스 경험 |
