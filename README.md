...
- 🛡️ **BoB 8기 취약점 분석 트랙**에서 한국형 버그바운티 플랫폼을 주제로 프로젝트를 했고, **공군사관학교**에서 망분리 환경 네트워크 관제를 했습니다.
...
BoB 8기 취약점 분석 트랙에서는 한국형 버그바운티 플랫폼을 주제로 프로젝트를 진행했습니다.
...
| 2019.07 ~ 2020.03 | BoB 8기 | 취약점 분석 트랙 · 한국형 버그바운티 플랫폼 프로젝트 |
